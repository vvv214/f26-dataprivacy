...
- Regrade requests should be submitted within 7 days of the grade release.
- A regrade asks us to review the entire submission, not just one line item.

### Project contributions

- Teams must include a short contribution statement for each milestone after the proposal.
